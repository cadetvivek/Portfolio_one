...
const NavBar = () => {
  ...
  return (
    <div className="flex justify-between items-center w-full h-20 px-4 bg-black text-white fixed">
      <div>
        <h1 className="text-2xl md:text-5xl font-signature ml-2">Vivek Kushwah</h1>
      </div>
      <div className="hidden md:flex">
        <ul className="flex">
          {links.map(({ id, link, text }) => (
            <li
              key={id}
              className="px-4 cursor-pointer capitalize font-medium text-amber-400 hover:scale-105 duration-200"
            >
